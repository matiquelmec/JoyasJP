...
import { Search, Users, ShoppingBag, Calendar, TrendingUp, Filter, Download, Mail, Phone, MapPin } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {((stats.repeat_customers / stats.total_customers) * 100).toFixed(1)}% del total
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              +{((stats.new_this_month / stats.total_customers) * 100).toFixed(1)}%
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="space-y-4">
            ...
            {filteredCustomers.length === 0 && (
              <div className="text-center py-8 text-muted-foreground">
                {searchTerm || filterStatus !== 'all' || selectedRegion !== 'all' 

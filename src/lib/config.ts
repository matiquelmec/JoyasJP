...
export const siteConfig = {
  ...
  seo: {
    ...
    defaultDescription: "Descubre la exclusiva colección de Joyas JP: alta joyería urbana con diseños únicos, materiales premium y estilo auténtico.",
    siteVerification: {
      google: "",
      bing: "",
    },

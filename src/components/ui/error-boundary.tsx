        ...
        <div className="flex items-center justify-center min-h-[300px] p-6">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              No pudimos cargar algunos productos. Por favor, intenta nuevamente.
            </p>
  ...
  return (
    <ErrorBoundary
      fallback={
        <div className="flex items-center justify-center min-h-[400px] p-6">
          <div className="text-center max-w-md">
            ...
            <h3 className="text-lg font-semibold mb-2">Error en el panel administrativo</h3>
            <p className="text-gray-600 mb-4">
              Ocurrió un error en el sistema administrativo. Por favor, recarga la página o contacta al soporte técnico.
            </p>
      ...
      onError={(error, errorInfo) => {
        ...
        console.error('ADMIN ERROR:', { error, errorInfo, timestamp: new Date().toISOString() });
      }}
    >
      {children}
    </ErrorBoundary>
